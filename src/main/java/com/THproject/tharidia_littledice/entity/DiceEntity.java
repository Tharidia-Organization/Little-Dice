...
public class DiceEntity extends Entity {
    ...
    public DiceEntity(EntityType<? extends DiceEntity> type, Level level) {
        super(type, level);
        this.setItem(TharidiaLittleDice.DICE.get().getDefaultInstance());
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(ITEM, TharidiaLittleDice.DICE.get().getDefaultInstance());
    }
    ...
    private void dropAsItem() {
        if (!level().isClientSide) {
            ...
            if (stack.isEmpty()) {
                stack = TharidiaLittleDice.DICE.get().getDefaultInstance();
            }
